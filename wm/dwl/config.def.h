...
static const float rootcolor[] = COLOR(0x171c1fff);
static const float bordercolor[] = COLOR(0x171c1fff);
static const float focuscolor[] = COLOR(0x839e9aff);
...
static const Rule rules[] = {
    ...
    {"zen", NULL, 1 << 0, 0, -1},       /* Start on ONLY tag "1" */
    {"Alacritty", NULL, 2 << 0, 0, -1}, /* Start on ONLY tag "2" */
                                        //     /* examples: */
};
...
static const char *const autostart[] = {
    "swaybg", "-i", "/home/eli/stuff/walls/rhod.jpg", NULL,
    "/home/eli/clones/someblocks/someblocks", "someblocks", NULL,
    NULL /* terminate */
};
// clang-format on
...
static const char *up[] = {"sh", "volup.sh", NULL};
static const char *down[] = {"sh", "voldown.sh", NULL};

static const char *brightnessup[] = {"sh", "brightnessctl.sh", "0", NULL};
static const char *brightnessdown[] = {"sh", "brightnessctl.sh", "1", NULL};
...
static const Key keys[] = {
    ...
    {MODKEY | WLR_MODIFIER_SHIFT, XKB_KEY_C, spawn, {.v = browsercmd}},
    {MODKEY | WLR_MODIFIER_SHIFT, XKB_KEY_P, spawn, {.v = colorpicker}},

    // media
    {0, XKB_KEY_XF86AudioLowerVolume, spawn, {.v = down}},
    {0, XKB_KEY_XF86AudioRaiseVolume, spawn, {.v = up}},
    {MODKEY | WLR_MODIFIER_CTRL, XKB_KEY_m, spawn, {.v = brightnessup}},
    {MODKEY | WLR_MODIFIER_CTRL, XKB_KEY_n, spawn, {.v = brightnessdown}},
    {0, XKB_KEY_XF86AudioRaiseVolume, spawn, {.v = up}},
